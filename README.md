...
This repository is organized into separate files for easier navigation. See the table of contents below.
...
1. Follow the [Setup Guide](setup.md) to install all required tools.
2. Proceed through the weeks in order, completing lectures and projects.
3. Check [Ethics](ethics.md) for best practices throughout.

## Contributing

See [Contributing](contributing.md) for GitHub workflows and how to improve this curriculum.
